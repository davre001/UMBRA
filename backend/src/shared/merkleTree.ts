...
// Mirrors contract/contracts/lib/MerkleTreeWithHistory.sol and
// frontend/src/lib/noteWallet/merkleTree.ts exactly.
...
/** See frontend/src/lib/noteWallet/merkleTree.ts for the full design note — same class, same behavior. */
