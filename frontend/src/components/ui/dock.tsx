    ...
    <div className={cn("flex items-center justify-center w-full py-12", className)}>
      <motion.div
        ...
        className={cn(
          ...
          "border border-border-custom bg-surface/70 backdrop-blur-2xl shadow-lg"
        )}
        style={{
                  ...
                  >
                    <Button
                      ...
                      className={cn(
                        ...
                        "transition-colors",
                        isHovered && "shadow-lg shadow-accent-primary/20"
                      )}
                      onClick={() => {
                    ...
                    >
                      ...
                      <AnimatePresence>
                        {isHovered && (
                          <motion.span
                            layoutId="glow"
                            className="absolute inset-0 rounded-2xl border border-accent-primary/40"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                          />
                    ...
                    {isActive && (
                      <motion.div
                        layoutId="dot"
                        className="w-1.5 h-1.5 rounded-full bg-accent-primary mt-1"
                      />
                    )}
                  </motion.div>
                </TooltipTrigger>
