...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-accent-primary text-bg-base hover:bg-accent-primary/90",
        destructive:
          "bg-red-500 text-white hover:bg-red-500/90",
        cool: "dark:inset-shadow-2xs dark:inset-shadow-white/10 bg-linear-to-t border border-b-2 border-zinc-950/40 from-accent-primary to-accent-primary/85 shadow-md shadow-accent-primary/20 ring-1 ring-inset ring-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 dark:border-x-0 text-bg-base dark:text-bg-base dark:border-t-0 dark:border-accent-primary/50 dark:ring-white/5",
        outline:
          "border border-border-custom bg-background hover:bg-surface hover:text-text-primary",
        secondary:
...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-105 duration-300 transition text-accent-primary",
        destructive:
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#FFA500]",
    inner: "bg-gradient-to-b from-accent-primary via-accent-secondary to-border-custom",
    button: "bg-gradient-to-b from-accent-primary to-accent-primary/40",
    textColor: "text-white",
