...
library WithdrawZKTranscriptLib {
...
abstract contract BaseZKHonkVerifier is IVerifier {
        ...
        returns (bool verified)
    {
        ...
        Honk.ZKProof memory p = WithdrawZKTranscriptLib.loadProof(proof, $LOG_N);
        ...
        ZKTranscript memory t =
            WithdrawZKTranscriptLib.generateTranscript(p, publicInputs, $VK_HASH, $NUM_PUBLIC_INPUTS, $LOG_N);
    ...
    function verifySumcheck(Honk.ZKProof memory proof, ZKTranscript memory tp) internal view returns (bool verified) {
        ...
        Fr grandHonkRelationSum = WithdrawRelationsLib.accumulateRelationEvaluations(
