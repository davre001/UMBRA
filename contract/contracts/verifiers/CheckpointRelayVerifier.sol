)
            }),
            s4: Honk.G1Point({ 
               x: uint256(0x0af3a5f7d4c306d5d50a8b72cba34f33c6b1dda4b0fcc844a16fe5bcbce804c2),
               y: uint256(0x277994dd17293a2022de535007bc6a864f464e932b6c7ac068458cca5cbd2c81)
            }),
            t1: Honk.G1Point({ 
               x: uint256(0x01a1e24842b133d6cc314d9a9fcc1c871a727e23b57538165a613343e00b7970),
               y: uint256(0x03de40a3ceb57bcfb7ac798edf00075222cf38f184dc4e4509c39f761889c557)
            }),
            t2: Honk.G1Point({ 
               x: uint256(0x043183818490c8774b6d5d4f56e4ac9895d7777ed80114834f2f32649f311b76),
               y: uint256(0x12d01ac6b9d933200e1ee13b9a8e973415750a26a5156c7c5ee9ed35615207cc)
            }),
            t3: Honk.G1Point({ 
               x: uint256(0x1aaca78611a2b2a8a1afc1caeac1d9621361f289887f20a82abdba2417961efe),
               y: uint256(0x12ce6a4cdcf36ba7398977b93e5eaa3ddc11625c72eb1869cb2cba227520270d)
            }),
            t4: Honk.G1Point({ 
               x: uint256(0x0a9167e40f8e14cf5344391089e6a09436563714482a32e435f0437a43db774c),
               y: uint256(0x1b447bf4090393790e1dbe17d8e099580321bca8ba0c6ac18d438c4ecfd6f9b9)
            }),
            id1: Honk.G1Point({ 
               x: uint256(0x1ce849cca07921e5cc0481e5252db7e6a32fe6ed3431f34ae3489bda1f9f4a4b),
               y: uint256(0x09d6b89cb6f15e8ec0fe5018ee54a0190ba4bd532c6baf24464b382a38976f6f)
            }),
            id2: Honk.G1Point({ 
               x: uint256(0x2a704e16ed60ffae8d7c76ee67a4e4ad7b72eb93ed25880403d70d50058b0229),
               y: uint256(0x24cfa120e80e50b6588e61929f441a33888643f25532bdbd06da465cfdf3e3cb)
            }),
            id3: Honk.G1Point({ 
               x: uint256(0x08ad9321becf6c9fded79f9b8fe5a6975384ff9b7a0600435a526d81b6fb33c8),
               y: uint256(0x0e93477a52b75d6b008aef90f3f1ce6f08d63ffe0bd9c809b3cc6378b619f318)
            }),
            id4: Honk.G1Point({ 
               x: uint256(0x273a2cd24dbfcd40ef2e9321e95a4d9c966665409352b1b1baceec44c61d92e9),
               y: uint256(0x28250a165e4ea3eef4540386e8366c043b82301508db6dc74514858e424a401a)
            }),
            ...
            lagrangeLast: Honk.G1Point({ 
               x: uint256(0x15dc12add85c045670a6285a1853005834cabe98360cdfb8a9f27f4f73b31c3e),
               y: uint256(0x1c882a34c3888ab8c2093ad9246caa7ea09d77ca6db019d91737e3303e33a7f2)
            })
        });
        return vk;
    }
...
library CheckpointRelayZKTranscriptLib {
...
library CheckpointRelayRelationsLib {
...
abstract contract BaseZKHonkVerifier is IVerifier {
        ...
        returns (bool verified)
    {
        ...
        Honk.ZKProof memory p = CheckpointRelayZKTranscriptLib.loadProof(proof, $LOG_N);
        ...
        ZKTranscript memory t =
            CheckpointRelayZKTranscriptLib.generateTranscript(p, publicInputs, $VK_HASH, $NUM_PUBLIC_INPUTS, $LOG_N);
    ...
    function verifySumcheck(Honk.ZKProof memory proof, ZKTranscript memory tp) internal view returns (bool verified) {
        ...
        Fr grandHonkRelationSum = CheckpointRelayRelationsLib.accumulateRelationEvaluations(
...
contract CheckpointRelayHonkVerifier is BaseZKHonkVerifier(N, LOG_N, VK_HASH, NUMBER_OF_PUBLIC_INPUTS) {
