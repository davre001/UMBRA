...
| Contract | Address |
| --- | --- |
| `ShieldedVault` | `0x13643D75088cfaB4737E8b6c85813e95bfaB450B` |
...
`ShieldedVault` was redeployed (2026-08-11) to add real Bitcoin bridging —
`depositExternal` now mints public `WrappedBTC` directly instead of a
hidden note, an ABI-breaking change. Every other contract above is
unchanged and reused from the prior deployment.
